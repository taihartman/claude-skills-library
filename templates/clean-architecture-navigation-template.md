...
description: Systematic workflow for understanding code in context by navigating architecture layers and tracing data flow
category: template
framework: any
architecture: clean-architecture, layered, hexagonal
---

# Clean Architecture Navigation Template

## Description
This template provides a systematic workflow for understanding code in context by finding and reading related files across architecture layers. Use this when you need to understand how a feature works, trace data flow, or gather context before making changes.
...
- [ ] **Architecture Layers** - Adapt the layer names to match your project (e.g., "Domain" vs "Core" vs "Business Logic")
- [ ] **Directory Structure** - Update file paths to match your project layout
- [ ] **Naming Conventions** - Adjust examples to match your project's naming patterns
- [ ] **Common Entry Points** - Document where files are typically located in YOUR project
- [ ] **Technology-Specific Patterns** - Add framework-specific navigation tips (e.g., Flutter widget trees, React component hierarchies)

**This is a template!** The examples below use Clean Architecture with Flutter/Dart, but the principles apply to any architecture (MVC, MVVM, Hexagonal, etc.) and any language/framework.
