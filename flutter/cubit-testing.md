---
name: cubit-testing
description: Systematic workflow for writing comprehensive BLoC/Cubit tests with Mockito - covers setup, mocking, state assertions, and test patterns
category: flutter
framework: flutter
---
...
## Description
This skill provides a systematic workflow for writing comprehensive BLoC/Cubit tests. Tests use Mockito for mocking dependencies and flutter_test for assertions.
