...
description: Systematic workflow for implementing mobile-first, responsive Flutter UI - ensures proper mobile UX with keyboard handling, responsive spacing, and touch targets
category: flutter
framework: flutter
---
...
## Description
This skill provides a systematic workflow for implementing mobile-first, responsive Flutter UI components. Use this when creating or refactoring any UI component.
